...
<div class="about-content" id="xmjsDiv" style="display: none;">
    <div class="tableDiv">
        <div class="textItem">
            ...
            <img class="xmjsImg" src="https://www.pujinziben.com/resources/front/v01/src/images/hengjin.png" alt="恒金保" width="900">
        </div>
        <div class="fgx"></div>
        <div class="textItem">
            ...
            <img class="xmjsImg" src="https://www.pujinziben.com/resources/front/v01/src/images/pujin.png" alt="普金保" width="900">
        </div>
        <div class="fgx"></div>
        <div class="textItem">
            ...
            <center><img class="xmjsImg" src="https://www.pujinziben.com/resources/front/v01/src/images/duojin.png" alt="多金保" width="550"></center>
        </div>
    </div>
</div>
<div class="about-content" id="jkrxxDiv" style="display: none;">
    <div class="tableDiv">
