...
<div class="about-content">
    ...
    <div id="falv" class="content">
        <div class="content-photo">
            <div class="content-photo-left">
                <img src="<%=path %>/static/images/xdp/guwen_01.png">
                <p class="name">赖华明</p>
                <p class="jobs">首席法律顾问</p>
            </div>
            <div class="content-photo-right">
                <p>就读于江西财经大学EMBA，2005始进入南芳律师事务所做专职律师，2014年5月至今在北京市中银（赣州）律师事务所工作。</p>
                <p>先后担任赣州市规划建设局、赣州市交通局、瑞金市人民政府、龙南县人民政府、赣州外商协会、赣江源商会、
                    赣州市盐业局、赣州市公路局大余分局、青峰药业、谱赛科（江西）生物技术有限公司、江西百福房地产、
                    赣州长发置业有限公司、赣州华大置业有限公司、赣州新起点工贸有限公司、南康鑫南投资有限公司、
                    赣州金地实业有限公司、江西贵竹房地产开发有限公司、赣州君嘉酒店集团、江西兴万家现代农业有限公司、
                    赣州名忠汽车有限公司、赣州锦城建设开发有限公司、《赣南社会科学》杂志、《城市经纬》杂志、
                    《赣州民营企业》杂志等四十余家行政、企事业单位的常年法律顾问。</p>
            </div>
        </div>
    </div>
    <div id="shiwu" class="content" style="display: none;">
        ...
        <p class="text">中银赣州团队近30人，秉承总所办所宗旨，长期致力于金融资本法律业务与企业法律风险管理实务，
            先后为40余家市重点企业提供常年法律顾问服务，与政府经济职能部门、当地司法资源保持着良好、健康的合作关系；
            赢得了业内外的良好口碑及品牌影响力。本所实施专业分工、团队合作运作模式，即每位律师专攻1-2个专业领域，
            以达到“因为专注、所以专业”，再由全所集中统筹，形成团队合力，组成有机团队为委托方提供全方位的法律服务。
            本所现设：金融法律事务部、法律风险管理事务部、人力资源法律事务部、知识产权法律事务部、
            房地产建设工程法律事务部及民商事争议解决中心等专业部门。</p>
