...
<div class="modal fade" id="update-media-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="updateForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group" >
                        <label for="updateMediaContent" class="col-sm-1 control-label">内&nbsp;&nbsp;容：</label>
                        <div class="col-sm-10">
                            <script id="updateMediaContent" name="content" type="text/plain" ></script>
                        </div>
                    </div>
                </form>
            </div>
