...
<div class="modal fade bs-example-modal-lg" id="update-bankcard-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="update-bankcard-form" class="form-horizontal">
                    ...
                    <%--<div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="rname" class="form-control" id="rname" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="idno" class="col-sm-2 control-label">身份证号</label>
                        <div class="col-sm-10">
                            <input name="idno" class="form-control" id="idno">
                        </div>
                    </div>--%>
                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="javascript:void(0);" onclick="bkCd.submit.update();"
