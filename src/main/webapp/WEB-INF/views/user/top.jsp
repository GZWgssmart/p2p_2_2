            ...
            <ul class="top-list" id="navigation">
                <c:choose>
                    <c:when test="${sessionScope.user != null}">
                        <li class="first"><a href="<%=topPath %>/user/logout">退出</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <li><a href="<%=topPath%>/user/home_page" class="pay">充值</a></li>
                <c:choose>
                    <c:when test="${sessionScope.user != null}">
                        <li id="userName"><a href="<%=topPath %>/user/home_page" class="user">${sessionScope.user.phone}</a></li>
                    </c:when>
                    <c:otherwise>
