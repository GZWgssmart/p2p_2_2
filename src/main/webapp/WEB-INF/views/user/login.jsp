        ...
        <div class="login-box">
            ...
            <form id="loginForm">
                <div class="from">
                    ...
                    <input id="phone" name="phone" id="phone" type="text" autocomplete="off" placeholder="输入手机号/邮箱"/>
                </div>
                <div class="from">
                    <label for="upwd" class="icon icon-pwd"></label>
                    <input id="upwd" name="upwd" id="upwd" type="password" autocomplete="new-password" placeholder="请输入密码" />
                </div>
                <div class="from">
                    <div class="pull-box">
