...
//		    	$('#transferBtn').unbind('click').click(function(){
//		    		//用户间转账
//		    		var transAmt=$("#transAmt").val();
//		    		var inUsrCustId=$("#inUsrCustId").val();
//        			var param={transAmt:transAmt,inUsrCustId:inUsrCustId}; 
//    				utils.ajax({
//    			        url:'front/usrTransfer.do',
//    			        data:JSON.stringify(param),
//    			        dataType:'json',
//    			        success: function(data){
//    			        	if(data.error==0){
//    			        		$('#transferPage').html(data.html);
//    			        	}else{
//    			        		utils.alert(data.msg);
//    			        	}	
//    			        }
